...
exports.convertADPtoWAVE = exports.convertToImageData = exports.extract = exports.seekImages = exports.iteratePlainImages = exports.parsePlain = exports.parseBETA = exports.parsePalette = exports.getPalette = exports.PalKeys = exports.parseGNA = void 0;
const CheckPattern = {
    3: 0x5500,
    4: 0xAA00,
    5: 0x55FF,
...
function parseGNA(gnadat, offset = 0) {
...
})(PalKeys = exports.PalKeys || (exports.PalKeys = {}));
...
function parsePalette(dv, offset = 0) {
 ...
 * @return {*}  {Object}
 */
function parseBETA(pdat, offset = 0) {
 ...
 * @return {*}
 */
function parsePlain(pdat, width = 8, height = 64, offset = 0) {
    const dv = new DataView(pdat, offset);
    const dat = new Uint8Array(pdat, offset);
...
function* iteratePlainImages(buffer, width = 14, height = 128, count, offset = 0) {
...
exports.iteratePlainImages = iteratePlainImages;
/**
...
* @return {*}  {Object}
*/
function* seekImages(buffer, offset = 0) {
 ...
 */
function* extract(buff, fname = '', getAsRaw = false) {
    let palkey;
    let foundPalette;
...
function convertToImageData(dat, pal) {
    const pix = dat.data;
...
exports.convertToImageData = convertToImageData;
function convertADPtoWAVE(buff) {
